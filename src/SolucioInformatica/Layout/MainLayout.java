package SolucioInformatica.Layout;

import processing.core.PApplet;
import static SolucioInformatica.Layout.Layout.*;

public class MainLayout extends PApplet {

    public static void main(String[] args) {
        PApplet.main("SolucioInformatica.LayoutNMides.MainLayout", args);
    }
