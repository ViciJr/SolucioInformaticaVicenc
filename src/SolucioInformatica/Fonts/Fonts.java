...
public class Fonts {
        ...
        void setFonts(PApplet p5){
            ...
            this.fonts[0] = p5.createFont("data/TTInterphasesProMonoTrialRegular.ttf", Mides.midaTitol);
            this.fonts[1] = p5.createFont("data/AltoneTrialRegular.ttf", Mides.midaSubtitol);
